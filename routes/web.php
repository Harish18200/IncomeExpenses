...
//PayNowTransfer Route
Route::get('/paynowTransfer', 'PaynowTransferController@index')->name('paynowTransfer.index');
Route::get('/paynowTransfer/create', 'PaynowTransferController@create')->name('paynowTransfer.create');
Route::post('/paynowTransfer/store', 'PaynowTransferController@store')->name('paynowTransfer.store');
Route::get('/paynowTransfer/edit/{id}', 'PaynowTransferController@edit')->name('paynowTransfer.edit');
Route::post('/paynowTransfer/update', 'PaynowTransferController@update')->name('paynowTransfer.update');
Route::get('/paynowTransfer/delete/{id}', 'PaynowTransferController@destroy')->name('paynowTransfer.delete');
